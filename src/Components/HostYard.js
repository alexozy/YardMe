...
const HostYardListing = () => {
  ...
  const img1 = 'https://www.outdooressentialproducts.com/-/media/OutdoorEssentialsV3/Products/Wood-Fence/Fence-Components/Pickets_LIFESTYLE.jpg'
  ...
  return (
    <div>
      <Form>
        ...
        <img style={{borderRadius: '10px'}} src={image} alt='text' height='300px' width='400px'/>
        <br />
